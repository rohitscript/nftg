...
const FooterLinks = ({ heading, items }) => (
  <div className="flex-1 justify-start items-start">
    ...
    {items.map((item, i) => (
      <p
        key={i}
        className="font-poppins dark:text-white text-nft-black-1 font-normal test-base cursor-pointer dark:hover:text-nft-gray-1 hover:text-nft-black-1 my-3"
      >
        {item}
      </p>
    ))}
...
const Footer = () => {
  ...
  return (
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 border-nft-gray-1 sm:py-8 py-16">
      {' '}
      {/* note: might have to remove sm:py-8 since content goes behind top nav */}
        ...
        <div className="flexStart flex-1 flex-col">
          ...
          <div className="flexBetween md:w-full minlg:w-557 w-357 mt-6 dark:bg-nft-black-2 bg-white border dark:border-nft-black-2 border-ft-gray-2 rounded-md">
            ...
            <div className="flex-initial">
              ...
              <Button
                btnName="Subscribe Our NewsLetter"
